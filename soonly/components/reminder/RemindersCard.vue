<template>
    <div
        ...
        <div class="flex justify-between items-start">
            ...
            <button @click="$emit('remove-reminder', reminder)"
                class="text-red-400 hover:text-red-600 transition-colors duration-200" aria-label="Remover lembrete"
        ...
        <div class="mt-5 space-y-3 max-h-48 overflow-y-auto pr-2">
            <div v-for="notification in reminder.notifications" :key="notification.id"
