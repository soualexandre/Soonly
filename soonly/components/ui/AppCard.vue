  ...
  >
    <div class="relative overflow-hidden rounded-t-2xl">
      ...
      <div class="absolute top-4 right-4 z-10">
        <div class="flex items-center justify-center w-8 h-8 rounded-full bg-black/30 backdrop-blur-sm border border-white/20 transition-all duration-300 group-hover:scale-110">
    ...
    <div class="p-4 space-y-4">
      ...
      >
        ...
        {{ isReminded ? 'Lembrete Ativo' : 'Adicionar Lembrete' }}
      </button>
    </div>
  </article>
</template>
