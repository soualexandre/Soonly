    ...
    <div class="relative z-20 h-full flex items-center max-w-7xl mx-auto">
      <div class="container w-full mx-auto px-6 md:px-12 lg:px-20">
        <div class="max-w-4xl">
          ...
          <h1 id="featured-media-title" class="text-5xl sm:text-6xl lg:text-8xl font-black mb-6 text-white leading-tight tracking-tight drop-shadow-2xl">
            {{ featuredMedia?.title }}
          </h1>
          ...
          <AppButton
            :icon="isAlreadyReminded ? 'i-heroicons-bell-alert' : 'i-heroicons-bell'"
            :variant="isAlreadyReminded ? 'primary' : 'secondary'"
            :aria-label="isAlreadyReminded ? 'Lembrete já criado' : 'Ativar lembrete'"
          ...
          >
            {{ isAlreadyReminded ? $t('home.reminderActive') : $t('home.remindMe') }}
          </AppButton>
          ...
          <ReminderConfirmModal
            ...
            :mediaTitle="featuredMedia?.title ?? ''"
            @confirm="onConfirmReminder"
